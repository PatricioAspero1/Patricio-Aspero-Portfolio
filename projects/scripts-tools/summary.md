...
Rather than listing programming languages by themselves, this page focuses on
how I use scripting to solve infrastructure problems, automate repetitive work,
monitor systems, and document my environment.
